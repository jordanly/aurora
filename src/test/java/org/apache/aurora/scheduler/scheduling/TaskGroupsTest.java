...
//    expect(taskScheduler.schedule(eq(ImmutableSet.of(TASK_A_ID))))
...
//    expect(taskScheduler.schedule(eq(ImmutableSet.of("a0", "a1"))))
//        .andReturn(ImmutableSet.of("a0", "a1"));
//    expect(taskScheduler.schedule(eq(ImmutableSet.of("b0"))))
